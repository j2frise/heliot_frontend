...
import { faBell, faCog, faEnvelope, faSearch, faSignOutAlt, faUserShield } from "@fortawesome/free-solid-svg-icons";
      ...
      <Container fluid className="px-0">
        <div className="d-flex justify-content-between w-100">
          ...
          <Nav className="align-items-center">
            <button className="btn btn-primary btn-sm me-lg-3">Aide</button>
            ...
            <Dropdown as={Nav.Item}>
              <Dropdown.Toggle as={Nav.Link} className="pt-1 px-0">
                <div className="media d-flex align-items-center">
                  <Image src={heticLogo} className="user-avatar md-avatar rounded-circle" />
                </div>
              </Dropdown.Toggle>
              <Dropdown.Menu className="user-dropdown dropdown-menu-right mt-2">
                <Dropdown.Item className="fw-bold">
                  <FontAwesomeIcon icon={faUserShield} className="me-2" /> Jarce boukoro
                </Dropdown.Item>
                <Dropdown.Item className="fw-bold">
                  <FontAwesomeIcon icon={faEnvelope} className="me-2" /> jarce.boukoro@hetic.net
                </Dropdown.Item>

                <Dropdown.Divider />

                <Dropdown.Item className="fw-bold" as={Link} to={Routes.Home.path} onClick={(e)=>{e.preventDefault();logout();}}>
